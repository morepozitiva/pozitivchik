...
@section('content')
                ...
                <div class="row">
                    <div class="colls works"><img data-toggle="tooltip" src="{{ asset('images/thumb/admiral.png') }}" alt="" title="@yield('work1')"></div>
                    <div class="colls works"><img data-toggle="tooltip" src="{{ asset('images/thumb/knyajevo.png') }}" alt="" title="@yield('work2')"></div>
                    <div class="colls works"><img data-toggle="tooltip" src="{{ asset('images/thumb/Ecoproject.png') }}" alt="" title="@yield('work3')"></div>
                </div> 
            </div>
@endsection
